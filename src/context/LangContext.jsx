...
const translations = {
  en: {
    ...
    /* Services */
    'Услуги и сервис': 'Services & amenities',
    'Расширьте ваш опыт проживания': 'Enhance your stay',
    'Дополнительные услуги': 'Additional services',
    'Как заказать услугу': 'How to order',
    'transfer': 'Airport transfer', 'breakfast': 'Breakfast', 'earlyCheckin': 'Early check-in', 'lateCheckout': 'Late checkout',
    'spa': 'Spa & massage', 'conference': 'Conference room', 'laundry': 'Laundry service', 'bikeRent': 'Bike rental',
    'Как заказать трансфер?': 'How to order a transfer?',
    'Напишите нам через WhatsApp или свяжитесь по телефону. Укажите время, количество человек и маршрут.': 'Contact us via WhatsApp or phone. Specify time, number of people and route.',
    'Можно ли заказать услугу прямо в номере?': 'Can I order a service from my room?',
    'Да, позвоните на рецепцию (доб. 0). Мы организуем услугу в удобное для вас время.': 'Yes, call reception (ext. 0). We will arrange the service at your convenience.',
    'Есть ли скидки за долгосрочное проживание?': 'Are there discounts for long-term stays?',
    'Да! При проживании 7+ ночей — скидка 10%, при 14+ ночах — скидка 15%. Свяжитесь с администратором.': 'Yes! 10% discount for 7+ nights, 15% for 14+ nights. Contact the administrator.',
    'Какой способ оплаты услуг?': 'What payment methods are available?',
    'Наличные, карта, банковский перевод. Оплата при получении услуги или по счёту заранее.': 'Cash, card, or bank transfer. Pay when service is delivered or by invoice in advance.',
    'Доступна по запросу': 'Available upon request',
    /* Admin */
    'Статус брони': 'Booking status', 'Новая': 'New', 'Подтверждена': 'Confirmed', 'Отменена': 'Cancelled',
    'Статус': 'Status', 'Оплачена': 'Paid', 'К оплате': 'Pending payment',
    'Уже рассмотрена': 'Already reviewed', 'Ждёт модерации': 'Awaiting moderation', 'Опубликовать': 'Publish',
    /* Booking */
